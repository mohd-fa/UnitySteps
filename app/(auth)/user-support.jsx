...
const userSupport = () => {
  const [selected, setSelected] = useState({
    "Yes, I have strong support from family and friends.": false,
    "Yes, but my support is limited.": false,
    "No, I don’t have a support system": false,
  });
        ...
        <View className=" p-8 h-full flex-col justify-between">
          <View>
            ...
            <Text className="pt-2 text-gray-500 font-pregular">
              This helps us understand if you have people to rely on during your
              recovery journey.
            </Text>
            {/* Check Box Code */}
